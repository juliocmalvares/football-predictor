    ...
    for i in arquivos:
        try:
            ...
            with open('match_' + str(counter_match) + '.json', 'w') as jsf:
                json.dump(dict(match), jsf, indent=4)
            os.chdir('..')
            ...
            with open('statistics_' + str(statistic_counter) + '.json', 'w') as jsf:
                json.dump(statistic_mandant, jsf, indent=4)
            statistic_counter += 1
            ...
            with open('statistics_' + str(statistic_counter) + '.json', 'w') as jsf:
                json.dump(statistic_visitant, jsf, indent=4)
            statistic_counter += 1
...
with open('teams.json', 'w') as jsf:
    json.dump(teams, jsf, indent=4)
